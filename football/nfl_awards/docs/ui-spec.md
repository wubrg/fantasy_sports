...
The awards reference system is complete. The data file (`nfl_awards_data.json`) contains 4,498 rows covering every AP award, All-Pro selection, and Pro Bowl selection for all 32 NFL franchises from 1994–2025.
...
1. `nfl_awards_data.json` — the full dataset (396 KB)
2. This spec doc
